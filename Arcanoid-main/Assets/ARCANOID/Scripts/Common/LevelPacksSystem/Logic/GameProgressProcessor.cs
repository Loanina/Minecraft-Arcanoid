...
namespace ARCANOID.Scripts.Common.LevelPacksSystem.Logic
{
    public class GameProgressProcessor
    {
        ...
        public GameProgressProcessor(ProgressSaveProvider progressSaveProvider, 
            Dictionary<string, LevelPack> packs)
        {
