...
using ARCANOID.Scripts.Common.LevelPacksSystem.Logic;
using UnityEngine;

namespace ARCANOID.Scripts.Common.LevelPacksSystem.API
{
    public class LevelPacksManager : MonoBehaviour
    {
        ...
        public void Init(JsonTokens jsonTokens, TextAsset tilesetFile, 
            CurrentSetOfPacksConfig config, StoredDataManager storedDataManager)
        {
            _config = config;
